                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="float-left">
                            <h4 class="mt-0 header-title">Viviendas</h4>
                        </div>
                            ...
                            <table id="datatable" class="table table-bordered">
                                ...
                                <tbody>
                                    @if(count($viviendas) > 0)
                                        @foreach($viviendas as $viviendas)
                                        <tr>
                                            <td>{{ $viviendas->id }}</td>
                                            <td>{{ $viviendas->direccion }}</td>
                                            <td>{{ $viviendas->jefe_hogar }}</td>
                                            <td>{{ $viviendas->cantidad_habitantes }}</td>
                                            <td class="text-center">
                                                @if($viviendas->estado == 1)                                                     
                                                    <a id="{{ $viviendas->id }}" href="" class="estado" title="Click para cambiar estado">
                                            ...
                                            <td>              
                                                <div class="float-right">
                                                    <div class="icon-demo-content row">
                                                        <a href="{{ route('viviendas.edit', $viviendas->id) }}" title="Editar vivienda">
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.code == 400){
                    ...
                    }else if(data.viviendas.estado == 1){
