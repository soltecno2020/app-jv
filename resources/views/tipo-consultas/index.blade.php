                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="float-left">
                            <h4 class="mt-0 header-title">Tipo de consulta</h4>
                        </div>
                                		...
                                		<tr>
                                			...
                                			<td class="text-center">
                                                @if($tipoConsulta->estado == 1)                                                     
                                                    <a id="{{ $tipoConsulta->id }}" href="" class="estado" title="Click para cambiar estado">
                                            ...
                                            <td>              
                                                <div class="float-right">
                                                    <div class="icon-demo-content row">
                                                        <a href="{{ route('tipoConsultas.edit', $tipoConsulta->id) }}" title="Editar tipo de consulta">
...
$(document).ready(function(){
	$('.estado').click(function(e){
        ...
        var id = this.id;
        $.ajax({
            url: 'tipoConsultas/cambiarEstado',
            type:'POST',
            headers: {
            ...
            success: function(data){
                ...
                if(data.code == 400){
                    ...
                    }else if(data.tipoConsulta.estado == 1){
