                                                ...
                                                @method('PUT')
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="alloptions" name="nombre" autocomplete="off" maxlength="30" value="{{ old('nombre', $tipoConsulta->nombre) }}">
                                                            @error('nombre')
                                                    ...
                                                    <a href="{{ route('tipoConsultas.index') }}" style="left:2.5%" class="btn btn-raised btn-danger mb-0">Cancelar</a>
                                                </form>
                                            </div>
                                        </div>
                                </div>
