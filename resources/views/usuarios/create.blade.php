                                                    ...
                                                    <div class="row grid-col p-3">
                                                        <div class="col-sm-6">
                                                            <div class="form-group is-focused">
                                                                ...
                                                                <input type="text" class="form-control" id="alloptions" name="name" autocomplete="off" maxlength="30" value="{{ old('name') }}" autofocus>
                                                                @error('name')
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="alloptions" name="apellido" autocomplete="off" maxlength="30" value="{{ old('apellido') }}" autofocus>
                                                                @error('apellido')
                                                                    <ul class="parsley-errors-list filled" id="parsley-id-9">
                                                                        <li class="parsley-required">
                                                                            <strong>
                                                    ...
                                                    <div class="row grid-col p-3">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="alloptions" name="email" autocomplete="off" maxlength="50" value="{{ old('email') }}" autofocus>
                                                                @error('email')
                                                                    <ul class="parsley-errors-list filled" id="parsley-id-9">
                                                                        <li class="parsley-required">
                                                                            <strong>
                                                    ...
                                                    <div class="row grid-col p-3">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" class="form-control" id="alloptions" name="password_confirmation" autocomplete="off" maxlength="30" value="{{ old('password') }}" autofocus>
                                                                @error('password')
                                                                    <ul class="parsley-errors-list filled" id="parsley-id-9">
                                                                        <li class="parsley-required">
                                                                            <strong>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" class="form-control" id="alloptions" name="password" autocomplete="off" maxlength="30" value="{{ old('password') }}" autofocus>
                                                                @error('password')
                                                                    <ul class="parsley-errors-list filled" id="parsley-id-9">
                                                                        <li class="parsley-required">
                                                                            <strong>
